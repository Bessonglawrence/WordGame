...
class _RandomSentencesState extends State<RandomSentences> {
  ...
  Widget _buildRow(String sentence) {
    ...
    return new ListTile(
      title: new Text(sentence, style: _biggerFont),
      trailing: new Icon(alreadyFoundFunny ? Icons.thumb_up : Icons.thumb_down,
  ...
  Widget _buildSentences() {
    return new ListView.builder(
        ...
        itemBuilder: (context, i) {
          // Add a pixel divider before each row
          ...
          // check to see if we've hit the end of the sentence list
